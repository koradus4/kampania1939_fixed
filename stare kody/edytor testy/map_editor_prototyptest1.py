...
class MapEditor:
    def __init__(self, root, config):
        ...
        # Zapytaj użytkownika o domyślną mapę (opcjonalnie)
        ...
        self.hex_data = {}
        # Słownik punktów kluczowych (np. mosty, miasta itp.)
        self.key_points = {}
        # Słownik punktów wystawienia: klucz - nazwa nacji, wartość - lista id heksów
        self.spawn_points = {}
        # Lista dostępnych nacjii do wyboru w GUI
        self.available_nations = ["Nacja A", "Nacja B"]
    ...
    def build_gui(self):
        ...
        # Przycisk "Otwórz Mapę" (ładowanie tła)
        ...
        # Przycisk "Zapisz dane" (roboczy plik danych)
        ...
        self.clear_button = tk.Button(buttons_frame, text="Reset danych", command=self.clear_variables,
                                      bg="saddlebrown", fg="white", activebackground="saddlebrown", activeforeground="white")
