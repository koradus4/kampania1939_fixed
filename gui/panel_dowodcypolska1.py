"""
Moduł zawierający klasę PanelDowodcyPolska1 odpowiedzialną za interfejs panelu dowódcy dla Polski (Gracz 1).
"""
import tkinter as tk
from tkinter import ttk, messagebox
from PIL import Image, ImageTk

class PanelDowodcyPolska1(tk.Toplevel):
    """
    Panel Dowódcy Polska 1 - okno z mapą, zegarem i przyciskiem zakończenia tury.
    """
    def __init__(self, parent, next_turn_callback):
        super().__init__(parent)
        self.title("Panel Dowódcy Polska - Gracz 1")
        ...
        # Wczytaj obraz mapy
        try:
            map_image = Image.open(r"C:\Users\klif\kampania1939_fixed\gui\mapa_cyfrowa\mapa_dowodca1.jpg")
