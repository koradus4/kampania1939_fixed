...
class PanelDowodcyPolska1(tk.Tk):
    def __init__(self, turn_number, remaining_time):
        ...
        self.general_name_label = tk.Label(self.left_frame, text="Generał Tadeusz Kutrzeba", font=("Arial", 12), bg="white", relief=tk.SUNKEN, borderwidth=2, wraplength=280, justify=tk.CENTER)
        ...
        general_image_path = "gui/images/Generał Tadeusz Kutrzeba.png"
