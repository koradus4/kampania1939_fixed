...
class PanelDowodcyPolska2(tk.Tk):
    def __init__(self, turn_number, remaining_time):
        ...
        panel_gracza = PanelGracza(self.left_frame, "c:/Users/klif/kampania1939_fixed/gui/images/Generał Juliusz Rómmel.png", "Generał Juliusz Rómmel")
    ...
    def update_economy(self, points):
        ...
        print(f"[DEBUG] Aktualizacja punktów ekonomicznych w PanelDowodcyPolska2: {points}")
        if not hasattr(self, 'points_frame'):
            print("[ERROR] points_frame nie został zainicjalizowany w PanelDowodcyPolska2")
        else:
