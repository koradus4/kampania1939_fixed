...
class PanelDowodcyNiemcy2(tk.Tk):
    def __init__(self, turn_number, remaining_time):
        super().__init__()
        self.title("Panel Dowódcy Niemcy 2")
        ...
        self.general_name_label = tk.Label(self.left_frame, text="Generał Fedor von Bock", font=("Arial", 12), bg="white", relief=tk.SUNKEN, borderwidth=2, wraplength=280, justify=tk.CENTER)
    ...
    def update_weather(self, weather_report):
        ...
        print(f"[DEBUG] PanelDowodcyNiemcy2: Otrzymano raport pogodowy: {weather_report}")
...
if __name__ == "__main__":
    app = PanelDowodcyNiemcy2(turn_number=1, remaining_time=60)
    app.mainloop()