"""
Moduł zawierający klasę PanelDowodcyNiemcy2 odpowiedzialną za interfejs panelu dowódcy dla Niemiec (Gracz 2).
"""
import tkinter as tk
from tkinter import ttk, messagebox
from PIL import Image, ImageTk

class PanelDowodcyNiemcy2(tk.Toplevel):
    """
    Panel Dowódcy Niemcy 2 - okno z mapą, zegarem i przyciskiem zakończenia tury.
    """
    def __init__(self, parent, next_turn_callback):
        super().__init__(parent)
        self.title("Panel Dowódcy Niemcy - Gracz 2")
