...
class TokenEditor:
    ...
    def build_controls(self):
        ...
        self.economic_points_var = tk.StringVar(value=str(self.available_points))
        tk.Label(economic_points_frame, textvariable=self.economic_points_var, bg="darkolivegreen", fg="#FFD700", font=("Arial", 16, "bold")).pack(side=tk.RIGHT, padx=5)
        ...
        # Lista dowódców przekazana z PanelGenerala
        self.commanders = self.available_commanders
        print(f"[DEBUG] Generał ma do wyboru dowódców: {self.commanders}")
        ...
        for label_text, var, fg_color, state in [
            ...
            tk.Entry(entry_frame, textvariable=var, width=entry_width, state=state).pack(side=tk.RIGHT)
